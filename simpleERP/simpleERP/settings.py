...
SECRET_KEY = 'django-insecure-^62q@te)$-r6f4i^n%qu2@bms(@h07oqk#0$do78(i8u+nd+&b'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': 'logs/invoice_debug.log',  # crea esta carpeta
        },
    },
    'loggers': {
        'django': {
        ...
        'crud': {  # pon aquí el nombre de tu app
            'handlers': ['file'],
            'level': 'DEBUG',
            'propagate': False,
        },
